...
//    public static final String INDEX_COMMAND = " /index";
    ...
    public static void main(String[] args) throws IOException, ImzMLConversionException {
        ...
        String[] filePaths = {"F:\\AstraZeneca\\MALDI Data for Josie\\05_Sept_2014_AZ13708229_Day_1_2_Recovery.raw",
                            "F:\\AstraZeneca\\MALDI Data for Josie\\18_Sept_2014_AZ13647935_Day_1_2_7.raw"};
        String[] patternFiles = {"D:\\GitProjects\\2013_12_11_ResolutionAndMatrixTest_Neg.pat"};
        
        for(int i = 0; i < filePaths.length; i++) {
            File[] mzMLFiles = WatersRAWTomzMLConverter.convert(filePaths[i]);

            for(File file : mzMLFiles) {
                System.out.println("Found : " + file.getAbsolutePath());
            }

            String[] inputFiles = {mzMLFiles[0].getAbsolutePath()};

            WatersMzMLToImzMLConverter converter = new WatersMzMLToImzMLConverter(filePaths[i], inputFiles, MzMLToImzMLConverter.FileStorage.oneFile);
            converter.setPatternFile(patternFiles[i]);
            converter.convert();
        }
    }
}
